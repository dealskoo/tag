...
@section('title',__('tag::tag.edit_tag'))
@section('body')
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">{{ __('tag::tag.edit_tag') }}</li>
                    </ol>
                </div>
                <h4 class="page-title">{{ __('tag::tag.edit_tag') }}</h4>
            </div>
        </div>
    </div>
    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text" class="form-control" id="name" name="name" required
                                       value="{{ old('name',$tag->name) }}" autofocus tabindex="1"
